...
classifier = ann_relu = MLPClassifier(activation = 'tanh', solver='lbfgs', alpha=1e-1, hidden_layer_sizes=(10, 2), random_state=1, warm_start=True)
...
title = "Figure 3: Neural Network Learning Curve"
